...
@Data
@Builder
public class T6Companies implements Serializable {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source field: public.t6_companies.primary_fiscal_id")
    private String primaryFiscalId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source field: public.t6_companies.legal_form_jurisdiction")
    private String legalFormJurisdiction;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source field: public.t6_companies.legal_form_code")
    private String legalFormCode;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source field: public.t6_companies.created_at")
