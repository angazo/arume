...
Generate MyBatis entities, generated repositories and XML mappers from the schema defined by the project's Flyway migrations, applied to a clean H2 in-memory database before generation.
