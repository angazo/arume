...
Company has a protected fiscal identity
...
Company preserves evolving data
...
Company supports local fiscal registrations
...
Jurisdiction codes are ISO alpha-2
...
Jurisdiction is selected from the localized countries catalog
