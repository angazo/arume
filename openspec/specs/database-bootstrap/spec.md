...
Defer Spring Boot startup until database configuration is available, bridge external configuration to system properties, and integrate Flyway migrations.
...
- **THEN** the system SHALL construct a JDBC URL in the format `jdbc:h2:file:<path>/arume;MODE=PostgreSQL;DATABASE_TO_LOWER=TRUE;DB_CLOSE_DELAY=-1`
